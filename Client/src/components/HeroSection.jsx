...
const HeroSection = () => {
  return (
    ...
    <div className="min-h-screen relative lg:p-12 bg-gradient-to-b from-blue-100 to-white flex items-center justify-center">
      <div className="container mx-auto lg:px-16 px-4 grid md:grid-cols-2 gap-12 items-center lg:mt-12 mt-28">
        {/* Text Content */}
