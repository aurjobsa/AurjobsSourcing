...
const CandidateLogin = ({navigateToRegister}) => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center py-12 px-4 animate-slide-out">
      <div className="w-[80%] flex shadow-lg rounded-lg overflow-hidden">
        {/* Left side - Login Form */}
        <div className="w-full md:w-1/2 flex items-center justify-center py-8 px-6 bg-white">
