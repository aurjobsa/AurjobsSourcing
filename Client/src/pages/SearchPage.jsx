              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
                ...
                <form onSubmit={handleSearch}  className="space-y-4 md:space-y-6">
                  ...
                  <button
                    ...
                    className="w-full z-10 bg-teal-500 text-white py-2 md:py-3 rounded-lg hover:bg-teal-600 transition-colors font-medium flex items-center justify-center gap-2"
                  >
                    Search Candidates
